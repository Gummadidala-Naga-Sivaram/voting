  ...
  <body>
    ...
    <div class="container" style="padding-top:150px;">
       ...
       $DB_NAME="db_evoting";
        ...
        $sq=mysqli_query($conn,"select * from sampledb where namee='$name' and voterid='$vid'");
        if(mysqli_num_rows($sq)==1)
        {
          $s="voted";
          $rs=mysqli_query($conn,"select * from tbl_users where full_name='$name' and voterid='$vid'");
